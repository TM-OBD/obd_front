...
function Footer() {
  ...
  return (
    ...
    >
      <Box // Container for medium/mobile image
        sx={{
          display: {
            xl: "none",
            lg: "none",
      ...
      <Box // container for navigation links
        sx={{
          display: "flex",
